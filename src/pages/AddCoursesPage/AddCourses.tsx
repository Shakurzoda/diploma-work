                            ...
                            options={[
                                {
                                    ...
                                    options: [
                                        {
                                            label: <span>Бэкенд-разработка</span>,
                                            value: 'backend-dev'
                                        },
                                        {
                                            label: <span>Веб-разработка</span>,
                                            value: 'frontend-dev'
                                        },
                                        {
                                            label: <span>Мобильная разработка</span>,
                                            value: 'mobiel-dev'
                                        },
                                        {
                                            label: <span>Анализ данных</span>,
                                            value: 'data-science'
                                        },
                                        {
                                            label: <span>IT-инфраструктура</span>,
                                            value: 'it-infrstr'
                                        }
                                    ]
                                },
